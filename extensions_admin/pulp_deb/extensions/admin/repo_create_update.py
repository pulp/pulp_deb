...
class PkgRepoOptionsBundle(OptionsBundle):
    ...
    def __init__(self):
        ...
        # Add custom options
        d = _('distribution releases (suites or codenames) to sync; defaults to stable')
        self.opt_releases = PulpCliOption('--releases', d,
                                          required=False)
...
class PkgRepoCreateCommand(CreateRepositoryCommand, ImporterConfigMixin):
    ...
    def populate_sync_group(self):
        ...
        self.sync_group.add_option(self.options_bundle.opt_releases)
