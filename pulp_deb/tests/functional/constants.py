...
DEB_FULL_FIXTURE_RELEASE_FILE_COUNT = 1
DEB_FIXTURE_PACKAGE_INDEX_COUNT = 4
DEB_FULL_FIXTURE_PACKAGE_INDEX_COUNT = 6
DEB_FIXTURE_PACKAGE_COUNT = 4
DEB_FULL_FIXTURE_PACKAGE_COUNT = 4
DEB_FIXTURE_INSTALLER_PACKAGE_COUNT = 0
DEB_FULL_FIXTURE_INSTALLER_PACKAGE_COUNT = 1
DEB_FIXTURE_GENERIC_CONTENT_COUNT = 0
DEB_FULL_FIXTURE_GENERIC_CONTENT_COUNT = 0
...
DEB_FIXTURE_SUMMARY = {
    ...
    # DEB_INSTALLER_PACKAGE_NAME: DEB_FIXTURE_INSTALLER_PACKAGE_COUNT,
    # DEB_GENERIC_CONTENT_NAME: DEB_FIXTURE_GENERIC_CONTENT_COUNT,
}

DEB_FULL_FIXTURE_SUMMARY = {
    DEB_RELEASE_FILE_NAME: DEB_FULL_FIXTURE_RELEASE_FILE_COUNT,
    DEB_PACKAGE_INDEX_NAME: DEB_FULL_FIXTURE_PACKAGE_INDEX_COUNT,
    DEB_PACKAGE_NAME: DEB_FULL_FIXTURE_PACKAGE_COUNT,
    DEB_INSTALLER_PACKAGE_NAME: DEB_FULL_FIXTURE_INSTALLER_PACKAGE_COUNT,
    # DEB_GENERIC_CONTENT_NAME: DEB_FULL_FIXTURE_GENERIC_CONTENT_COUNT,
}
