# coding=utf-8
"""Tests that CRUD verbatim publishers."""
import unittest
...
from pulp_deb.tests.functional.constants import DEB_VERBATIM_PUBLISHER_PATH
from pulp_deb.tests.functional.utils import gen_deb_verbatim_publisher, skip_if
from pulp_deb.tests.functional.utils import set_up_module as setUpModule  # noqa:F401


class CRUDVerbatimPublishersTestCase(unittest.TestCase):
    """CRUD publishers."""
    ...
    def test_01_create_publisher(self):
        """Create a publisher."""
        body = gen_deb_verbatim_publisher()
        type(self).publisher = self.client.post(DEB_VERBATIM_PUBLISHER_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(DEB_VERBATIM_PUBLISHER_PATH, body)
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(DEB_VERBATIM_PUBLISHER_PATH, params={
