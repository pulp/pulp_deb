...
class AptAlternateContentsourceViewSet(AlternateContentSourceViewSet, RolesMixin):
    ...
    queryset_filtering_required_permission = "apt.view_aptalternatecontentsource"
    ...
    DEFAULT_ACCESS_POLICY = {
        "statement": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_or_domain_or_obj_perms:apt.view_aptalternatecontentsource",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
                "effect": "allow",
                "condition": [
                    "has_remote_param_model_or_domain_or_obj_perms:apt.view_aptremote",
                    "has_model_or_domain_perms:apt.add_aptalternatecontentsource",
                ],
            },
            {
                "action": ["refresh"],
                ...
                "effect": "allow",
                "condition": [
                    "has_model_or_domain_or_obj_perms:apt.view_aptalternatecontentsource",
                    "has_model_or_domain_perms:apt.refresh_aptalternatecontentsource",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_or_domain_or_obj_perms:apt.change_aptalternatecontentsource",
                    "has_model_or_domain_or_obj_perms:apt.view_aptalternatecontentsource",
                    "has_remote_param_model_or_domain_or_obj_perms:apt.view_aptremote",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_or_domain_or_obj_perms:apt.delete_aptalternatecontentsource",
                    "has_model_or_domain_or_obj_perms:apt.view_aptalternatecontentsource",
                ],
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_or_domain_or_obj_perms:apt.manage_roles_aptalternatecontentsource",
            },
        ],
        ...
        "creation_hooks": [
            {
                ...
                "parameters": {"roles": "apt.aptalternatecontentsource_owner"},
            }
        ],
    }

    LOCKED_ROLES = {
        "apt.aptalternatecontentsource_owner": [
            "apt.change_aptalternatecontentsource",
            "apt.delete_aptalternatecontentsource",
            "apt.manage_roles_aptalternatecontentsource",
            "apt.refresh_aptalternatecontentsource",
            "apt.view_aptalternatecontentsource",
        ],
        "apt.aptalternatecontentsource_creator": [
            "apt.add_aptalternatecontentsource",
        ],
        "apt.aptalternatecontentsource_viewer": [
            "apt.view_aptalternatecontentsource",
        ],
    }
    ...
    def refresh(self, request, pk):
        ...
        optimize = AptRepositorySyncURLSerializer().data["optimize"]
        skip_types = AptRepositorySyncURLSerializer().data["skip_types"]
