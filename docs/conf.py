...
latex_documents = [
  ('index', 'PulpDeb.tex', u'Pulp Deb Documentation',
   u'Pulp Team', 'manual'),
]
...
man_pages = [
    ('index', 'pulpdeb', u'Pulp Deb Documentation',
     [u'Pulp Team'], 1)
]
...
texinfo_documents = [
  ('index', 'PulpDeb', u'Pulp Deb Documentation',
   u'Pulp Team', 'PulpDeb', 'One line description of project.',
   'Miscellaneous'),
]
